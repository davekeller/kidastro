    ...
    <AnimatedSection className="quotapath grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 items-center">
      <div className="col-span-full w-full lg:w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12 items-start">
        ...
        <div className="info text-left text-white px-8 py-8 border-2 border-white/10 rounded-2xl">
          ...
          <h4 className="text-(--color-2) text-lg font-bold italic border-b-2 border-white/10 pb-4 mb-4">Sales commission software, minus the spreadsheet headache</h4>
          <p className="mb-4 text-lg leading-8 text-white/90">
            Commission plans are a tangle of rates, tiers, and edge cases. I designed across teams at this Series B platform to make that math clear, shipping features monthly and building the Compensation Hub from scratch so sales teams could explore, compare, and model plans.
          </p>
        </div>
