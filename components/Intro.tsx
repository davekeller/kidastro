  ...
  return (
    <div className="relative flex flex-col items-center justify-start bg-transparent text-center -mt-10 pb-0 md:pb-48">
      ...
      <div className="intro flex flex-col items-center max-w-[850px] mx-auto px-6 z-10 -mt-40 md:-mt-[136px]">
        ...
        <p className="mb-8 max-w-[800px] text-balance leading-loose">
          Now I design primarily in the browser, with Claude Code/Codex and Tailwind — building functional prototypes and shipping production code. I enjoy the creative process, architecting systems, working with smart people, and celebrating the wins. Thanks for checking out my work.
        </p>
        </FadeUp>
