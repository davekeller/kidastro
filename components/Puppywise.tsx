...
const Puppywise = () => {
  return (
    <AnimatedSection className="puppy grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
      <div className="info col-span-1 md:col-span-2 text-left text-white px-8 py-8 border-2 border-white/10 rounded-2xl max-w-3xl mx-auto mb-12">
