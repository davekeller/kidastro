...
const Header = () => {
  return (
    <header className="mb-8 flex flex-col items-start gap-8 sm:flex-row sm:items-center sm:justify-between">
      <div className="flex flex-col items-start gap-5 sm:flex-row sm:items-center">
        <Image
          ...
          width={96}
          height={96}
          className="h-[96px] w-[96px] rounded-full border-2 border-white/10 object-cover"
          priority
        />
        <div>
