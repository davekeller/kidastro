      ...
      <div className="col-span-full w-full lg:w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12 items-start">
        ...
        <div className="info text-left text-white px-8 py-8 border-2 border-white/10 rounded-lg flex flex-col items-start">
          ...
          <ul className="list-none space-y-4 w-full">
             <li className="pl-6 relative before:content-['+'] before:absolute before:left-0 before:top-0 before:font-bold before:text-white/30 text-lg leading-snug text-white/90">Hired and led a 20-person team across product, back-end, front-end, iOS, and Android</li>
             <li className="pl-6 relative before:content-['+'] before:absolute before:left-0 before:top-0 before:font-bold before:text-white/30 text-lg leading-snug text-white/90">Designed and shipped custom apps and websites across 30+ client projects</li>
             <li className="pl-6 relative before:content-['+'] before:absolute before:left-0 before:top-0 before:font-bold before:text-white/30 text-lg leading-snug text-white/90">Ran sales, marketing, and accounts across dozens of engagements</li>
             <li className="pl-6 relative before:content-['+'] before:absolute before:left-0 before:top-0 before:font-bold before:text-white/30 text-lg leading-snug text-white/90">Designed and built A Beautiful Mess, the photo editor that hit #1 Paid on the App Store</li>
             <li className="pl-6 relative before:content-['+'] before:absolute before:left-0 before:top-0 before:font-bold before:text-white/30 text-lg leading-snug text-white/90">Designed and built a multi-million-dollar CRM/CMS for one of the largest US auto-sales organizations</li>
          </ul>
        </div>
      </div>
