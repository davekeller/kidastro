    ...
    <AnimatedSection className="strangeworks grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 items-center">
      <div className="col-span-full w-full lg:w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12 items-start">
        ...
        <div className="info text-left text-white px-8 py-8 border-2 border-white/10 rounded-lg">
          ...
          <h4 className="accent-text text-lg font-bold italic border-b-2 border-white/10 pb-4 mb-4">A data-science consulting company for Fortune 500 teams running AI, quantum, and HPC compute</h4>
        ...
        <div className="info text-left text-white px-8 py-8 border-2 border-white/10 rounded-lg flex flex-col items-start">
          ...
          <ul className="list-none space-y-4 w-full">
             <li className="pl-6 relative before:content-['+'] before:absolute before:left-0 before:top-0 before:font-bold before:text-white/30 text-lg leading-snug text-white/90">Promoted from Senior Product Designer to Director of Product in 6 months</li>
             <li className="pl-6 relative before:content-['+'] before:absolute before:left-0 before:top-0 before:font-bold before:text-white/30 text-lg leading-snug text-white/90">Researched internal process and designed the vision for Aura, our workflow app — then helped build it in production code</li>
             <li className="pl-6 relative before:content-['+'] before:absolute before:left-0 before:top-0 before:font-bold before:text-white/30 text-lg leading-snug text-white/90">Embedded with engineering, leadership, and the science team to ship across the compute platform, docs, and marketing sites</li>
             <li className="pl-6 relative before:content-['+'] before:absolute before:left-0 before:top-0 before:font-bold before:text-white/30 text-lg leading-snug text-white/90">Designed dozens of client optimization apps — staff scheduling, fleet routing, and more</li>
          </ul>
        </div>
      </div>
